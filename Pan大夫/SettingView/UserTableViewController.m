...
//            registinformationViewController = [storyboard instantiateViewControllerWithIdentifier:@"Regist"];
            ...
            NSString* nickname = [plistDictionary objectForKey:@"login"];
            if (nickname!=nil) {
                ModifyInformationViewController *modifyInformationViewController = [[ModifyInformationViewController alloc]initWithNav:YES SettingsViewController:(SettingsViewController*)[self viewController]];
                modifyInformationViewController.hidesBottomBarWhenPushed = YES;
                modifyInformationViewController.title = @"修改信息";
                [[self viewController].navigationController pushViewController:modifyInformationViewController animated:YES];
