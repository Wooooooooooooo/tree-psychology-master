...
#define   userImageNewW (((FrameH > 567) && (FrameH < 569))?100:(((FrameH > 666) && (FrameH < 668))? 100*ratio6 : (((FrameH > 735) && (FrameH < 737))? 100*ratio6plus : 100)))
#define   userImageH  (((FrameH <= 567)?80:(FrameH > 567) && (FrameH < 569))?100:(((FrameH > 666) && (FrameH < 668))? 100*ratio6 : (((FrameH > 735) && (FrameH < 737))? 100*ratio6plus : 100)))
...
#define   telH  (((FrameH <= 567)?30:(FrameH > 567) && (FrameH < 569))?38:(((FrameH > 666) && (FrameH < 668))? 38*ratio6 : (((FrameH > 735) && (FrameH < 737))? 38*ratio6plus : 38)))
...
#define   uptel  (((FrameH <=568)?10:(FrameH > 567) && (FrameH < 569))?84:(((FrameH > 666) && (FrameH < 668))? 84*ratio6 : (((FrameH > 735) && (FrameH < 737))? 84*ratio6plus : 30)))
